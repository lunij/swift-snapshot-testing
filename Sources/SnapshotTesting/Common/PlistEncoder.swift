...
private struct _PlistUnkeyedDecodingContainer: UnkeyedDecodingContainer {
  ...
  public mutating func decode(_ type: Int16.Type) throws -> Int16 {
    ...
    guard let decoded = try self.decoder.unbox(self.container[self.currentIndex], as: Int16.self)
    else {
      throw DecodingError.valueNotFound(
        type,
        DecodingError.Context(
  ...
  public mutating func decode(_ type: Int32.Type) throws -> Int32 {
    ...
    guard let decoded = try self.decoder.unbox(self.container[self.currentIndex], as: Int32.self)
    else {
      throw DecodingError.valueNotFound(
        type,
        DecodingError.Context(
  ...
  public mutating func decode(_ type: Int64.Type) throws -> Int64 {
    ...
    guard let decoded = try self.decoder.unbox(self.container[self.currentIndex], as: Int64.self)
    else {
      throw DecodingError.valueNotFound(
        type,
        DecodingError.Context(
  ...
  public mutating func decode(_ type: UInt8.Type) throws -> UInt8 {
    ...
    guard let decoded = try self.decoder.unbox(self.container[self.currentIndex], as: UInt8.self)
    else {
      throw DecodingError.valueNotFound(
        type,
        DecodingError.Context(
  ...
  public mutating func decode(_ type: UInt16.Type) throws -> UInt16 {
    ...
    guard let decoded = try self.decoder.unbox(self.container[self.currentIndex], as: UInt16.self)
    else {
      throw DecodingError.valueNotFound(
        type,
        DecodingError.Context(
  ...
  public mutating func decode(_ type: UInt32.Type) throws -> UInt32 {
    ...
    guard let decoded = try self.decoder.unbox(self.container[self.currentIndex], as: UInt32.self)
    else {
      throw DecodingError.valueNotFound(
        type,
        DecodingError.Context(
  ...
  public mutating func decode(_ type: UInt64.Type) throws -> UInt64 {
    ...
    guard let decoded = try self.decoder.unbox(self.container[self.currentIndex], as: UInt64.self)
    else {
      throw DecodingError.valueNotFound(
        type,
        DecodingError.Context(
...
nonisolated(unsafe) private let _plistNullNSString = NSString(string: _plistNull)
