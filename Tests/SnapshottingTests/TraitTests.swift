...
struct TraitTests {
  @Test func `traits`() async {
    ...
    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2010, .landscape).windowed(width: 320)), named: "ipad-mini-320-landscape")
    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2010, .landscape).windowed(width: 507)), named: "ipad-mini-507-landscape")
    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2010, .landscape).windowed(width: 694)), named: "ipad-mini-694-landscape")
    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2010, .portrait).windowed(width: 320)), named: "ipad-mini-320-portrait")
    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2010, .portrait).windowed(width: 438)), named: "ipad-mini-438-portrait")

    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2019, .landscape).windowed(width: 320)), named: "ipad-10-2-320-landscape")
    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2019, .landscape).windowed(width: 535)), named: "ipad-10-2-535-landscape")
    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2019, .landscape).windowed(width: 750)), named: "ipad-10-2-750-landscape")
    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2019, .portrait).windowed(width: 320)), named: "ipad-10-2-320-portrait")
    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2019, .portrait).windowed(width: 480)), named: "ipad-10-2-480-portrait")

    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2017, .landscape).windowed(width: 320)), named: "ipad-pro-10inch-320-landscape")
    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2017, .landscape).windowed(width: 551)), named: "ipad-pro-10inch-551-landscape")
    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2017, .landscape).windowed(width: 782)), named: "ipad-pro-10inch-782-landscape")
    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2017, .portrait).windowed(width: 320)), named: "ipad-pro-10inch-320-portrait")
    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2017, .portrait).windowed(width: 504)), named: "ipad-pro-10inch-504-portrait")

    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2018, .landscape).windowed(width: 375)), named: "ipad-pro-11inch-375-landscape")
    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2018, .landscape).windowed(width: 592)), named: "ipad-pro-11inch-592-landscape")
    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2018, .landscape).windowed(width: 809)), named: "ipad-pro-11inch-809-landscape")
    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2018, .portrait).windowed(width: 320)), named: "ipad-pro-11inch-320-portrait")
    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2018, .portrait).windowed(width: 504)), named: "ipad-pro-11inch-504-portrait")

    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2015, .landscape).windowed(width: 375)), named: "ipad-pro-12inch-375-landscape")
    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2015, .landscape).windowed(width: 678)), named: "ipad-pro-12inch-678-landscape")
    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2015, .landscape).windowed(width: 981)), named: "ipad-pro-12inch-981-landscape")
    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2015, .portrait).windowed(width: 375)), named: "ipad-pro-12inch-375-portrait")
    await expectSnapshot(of: vc, as: .image(on: .iPad(.year2015, .portrait).windowed(width: 639)), named: "ipad-pro-12inch-639-portrait")
